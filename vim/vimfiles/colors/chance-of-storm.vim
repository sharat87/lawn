...
" Version: 1
" Modified: Shrikant Sharat Kandula
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
hi CursorLineNr         guifg=#6983ba   guibg=bg      gui=bold
hi SignColumn                           guibg=#23292f gui=none
...
hi VertSplit            guifg=#0d0f11   guibg=#0d0f11 gui=none
 " Selected text color
hi Visual               guifg=#dfeff6   guibg=#137f42 gui=none
...
hi Todo                 guifg=#ADED80   guibg=bg      gui=bold,italic
...
hi      rubyAccess                  guifg=#ef7760 guibg=bg gui=none
