...
let g:colors_name = "default_inkling"
...
if &background ==# 'light'
	...
	hi NonText    guifg=#B8D5FF

	hi Comment gui=italic guifg=darkorange

	hi Constant gui=none guifg=SeaGreen
	hi Type gui=none guifg=Magenta

	" Setting reverse here increases the priority of this highlight group.
	...
	if has("gui_running")
		...
		hi CursorLineNr       guibg=#2e2e37
		hi ColorColumn        guibg=#3e1e27
		...
		hi VertSplit      gui=NONE   guifg=#3e3e5e   guibg=#3e3e5e
		...
		hi SignColumn     gui=NONE   guifg=#cd8b00   guibg=#2e2e2e
		...
		hi Todo           gui=BOLD   guifg=#ff0099   guibg=NONE
